...
public class ShangpinOrderEntity<T> implements Serializable {
     ...
     * 快递单号
     */
    @TableField(value = "shangpin_order_kuaididanhao")

    private String shangpinOrderKuaididanhao;
    ...
    public String getShangpinOrderKuaididanhao() {
        return shangpinOrderKuaididanhao;
    }

    public void setShangpinOrderKuaididanhao(String shangpinOrderKuaididanhao) {
        this.shangpinOrderKuaididanhao = shangpinOrderKuaididanhao;
    }
    ...
    public String toString() {
        return "ShangpinOrder{" +
            ...
            ", shangpinOrderKuaididanhao=" + shangpinOrderKuaididanhao +
