            ...
            BeanUtils.copyProperties( shangpinOrder , view );//把实体数据重构到view中
                ...
                if(shangpin != null){
                    ...
                    if(shangjia != null) {
                        ...
                        view.setShangpinShangjiaId(shangpin.getId());
                    }
                }
                //级联表
...
//                            shangpinOrderEntity.setQuhuoTypes(Integer.valueOf(data.get(0)));   //取货方式 要改的
...
//                            shangpinOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer quhuoTypes = Integer.valueOf(String.valueOf(params.get("quhuoTypes")));//取货方式
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            shangpinOrderEntity.setQuhuoTypes(quhuoTypes);//取货方式 ？？？？？？
    ...
    */
    ...
    public R deliver(Integer id ,String shangpinOrderKuaididanhao){
        logger.debug("refund:,,Controller:{},,id:{},,shangpinOrderKuaididanhao:{}",this.getClass().getName(),id.toString(),shangpinOrderKuaididanhao);
        ShangpinOrderEntity  shangpinOrderEntity = new  ShangpinOrderEntity();;
        shangpinOrderEntity.setId(id);
        shangpinOrderEntity.setShangpinOrderTypes(4);
        shangpinOrderEntity.setShangpinOrderKuaididanhao(shangpinOrderKuaididanhao);;
