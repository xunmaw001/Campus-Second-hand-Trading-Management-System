  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'" label='商家照片展示' prop="shangjiaPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='现积分' prop="yonghuNewJifen">
                 <el-input v-model="ruleForm.yonghuNewJifen"  placeholder='现积分' disabled ></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
