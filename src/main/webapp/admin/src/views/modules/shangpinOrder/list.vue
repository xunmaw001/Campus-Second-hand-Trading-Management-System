<template>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/ershoujiaoyipingtai/upload/shangpinOrderMuBan.xls"
                        >批量导入商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
                                style="display: inline-block"
                                action="ershoujiaoyipingtai/file/upload"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      ...
                                      label="取货方式">
                        <template slot-scope="scope">
                            {{scope.row.quhuoValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="shangpinOrderKuaididanhao"
                                      header-align="center"
                                      label="快递单号">
                        <template slot-scope="scope">
                            {{scope.row.shangpinOrderKuaididanhao}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 3 && sessionTable=='shangjia' && userId==scope.row.shangpinShangjiaId" type="primary" icon="el-icon-reading" size="mini" @click="openDeliver(scope.row.id)">发货</el-button>
 ...
 //发货
        ...
        <el-dialog title="发货" :visible.sync="deliverVisible" width="30%">
            <span>快递单号:</span>
            <el-input type="text" v-model="shangpinOrderKuaididanhao"></el-input>
            <span slot="footer" class="dialog-footer">
...
<script>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            openDeliver(id){
                //清空快递单号
                this.shangpinOrderKuaididanhao = "";
                //赋值
                this.deliverId = id;
                //打开模态框
            ...
            deliver(){
                ...
                this.$confirm(`确定要发货吗?`, "提示", {
                    ...
                    this.$http({
                        url: "shangpinOrder/deliver?id="+_this.deliverId+"&shangpinOrderKuaididanhao="+_this.shangpinOrderKuaididanhao,
                        method: "post",
                    }).then(({ data }) => {
                        if (data && data.code === 0) {
                            this.$message({
