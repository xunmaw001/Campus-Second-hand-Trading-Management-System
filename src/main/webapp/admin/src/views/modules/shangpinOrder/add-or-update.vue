    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="type=='info' ">
                    <div>
                        <el-form-item class="input" label="商家联系方式" prop="shangjiaPhone">
                            <el-input v-model="ruleForm.shangjiaPhone"
                                      placeholder="商家联系方式" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="type=='info' ">
                    <div>
                        <el-form-item v-if="ruleForm.shangjiaPhoto" label="商家照片展示" prop="shangjiaPhoto">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="取货方式" prop="quhuoTypes">
                        <el-select v-model="ruleForm.quhuoTypes" :disabled="ro.quhuoTypes" placeholder="请选择取货方式">
                            <el-option
                                v-for="(item,index) in quhuoTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="取货方式" prop="quhuoValue">
                        <el-input v-model="ruleForm.quhuoValue"
                            placeholder="取货方式" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="快递单号" prop="shangpinOrderKuaididanhao">
                        <el-input v-model="ruleForm.shangpinOrderKuaididanhao"
                                  placeholder="快递单号" clearable  :readonly="ro.shangpinOrderKuaididanhao"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="快递单号" prop="shangpinOrderUuidNumber">
                            <el-input v-model="ruleForm.shangpinOrderKuaididanhao"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    shangpinOrderKuaididanhao: false,
                    addressId: false,
                    shangpinId: false,
                    yonghuId: false,
                    buyNumber: false,
                ...
                rules: {
                   ...
                   quhuoTypes: [
                              { required: true, message: '取货方式不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=quhuo_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.quhuoTypesOptions = data.data.list;
                    }
                });
                this.$http({
