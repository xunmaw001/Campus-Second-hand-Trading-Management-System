        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangjiaPhoto" label="商家照片展示" prop="shangjiaPhoto">
                        <file-upload
                            tip="点击上传商家照片展示"
                            action="file/upload"
                            :limit="3"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="商家星级类型" prop="shangjiaXingjiTypes">
                        <el-select v-model="ruleForm.shangjiaXingjiTypes" :disabled="ro.shangjiaXingjiTypes" placeholder="请选择商家星级类型">
                            <el-option
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangjiaPhoto: [
                              { required: true, message: '商家照片展示不能为空', trigger: 'blur' },
                          ],
                   shangjiaXingjiTypes: [
                              { required: true, message: '商家星级类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
